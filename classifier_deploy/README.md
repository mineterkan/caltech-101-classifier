...
## Model file
The model file (caltech_classifier_cpu.pkl) is not included in the repo due to size.
To get it, run the training notebook first:
`lessons/intro/homework/modified/02_exercise_train_your_own.ipynb`
